    ...
    <div>
      <section className="min-h-full relative flex items-center gap-8">
        <div className="header__text flex flex-col gap-2 z-50 pl-8 max-w-[50%] mt-20 h-[100vh] justify-center">
          ...
          <h3 className="font-subsites text-[1.4rem] 01">(Community)</h3>
          <p className="w-[60%]">
      ...
      <section className="my-40 mx-4 grid-cols-1 grid gap-8">
        ...
        <div className="text__main self-end">
          ...
          JOMO exercitation la croix banh mi 8-bit health goth big mood. Quinoa
          ...
          snackwave minim. 90&apos;s celiac bushwick shoreditch hot chicken
          neutral milk hotel shabby chic mollit. Viral celiac vaporware aliquip
          vice paleo. Tilde nostrud scenester leggings gatekeep, semiotics
