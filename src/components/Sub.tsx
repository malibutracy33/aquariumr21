...
interface SubsiteContentProps {
  id: Subsites["id"]; // Ensure the id is of the correct type
}

export function SubsiteContent({ id }: SubsiteContentProps) {
  const subsite = getSubsiteData(id);

  // If no matching subsite is found, return an error message
